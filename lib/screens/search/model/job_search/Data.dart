...
class Data {
    ...
    Data({this.applied_count, this.category_id, this.company_name, this.created_at, this.experience_form, this.experience_to, this.id, this.img, this.job_description, this.job_type, this.location, this.other_skills, this.salary_from, this.salary_to, this.skills, this.skills_name, this.status, this.title, this.updated_at, this.user_id, this.working_hours});
